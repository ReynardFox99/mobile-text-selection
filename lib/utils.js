...
export function isSameLine(relativeY, currentY, currentHeight) {
  return currentY >= relativeY - currentHeight / 2 && currentY <= relativeY + currentHeight / 2;
}
export function isAfterLine(relativeY, currentY,currentHeight) {
  return currentY > relativeY + currentHeight / 2 ;
}
export function isPreviousLine(relativeY, currentY, currentHeight) {
  return currentY < relativeY - currentHeight / 2;
}
